...
jQuery(function () {
  var addError, email, firstName, gender, getId, getIds, isValidEmailAddress, lastName, password, removeError, repeatPassword, required, setError, trimField, verifyEmailAddressField, verifyPasswordsMatch, verifyRequiredField, verifyRequiredRadio;
  getId = function (id) {
    return $("#" + id);
  };
