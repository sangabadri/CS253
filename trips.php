...
<?php if (user\user_logged_in()): ?>
  ...
  <secton id="admin">
    <div class="container container-fluid">
      <header id="admin-header-driving">
        <h2>Driving</h2>
        <p>Upcoming trips for which you are driving. Use this section to approve or deny ride requests, manage, and plan
          your trip details.</p>
        ...
        <tbody id="trips-driving">
          <tr>
            <td id="trips-driving-status" colspan="5">
              ...
              <em id="trips-driving-msg" style="display: none;">There are no upcoming trips for which you are
                driving.</em>
            </td>
          </tr>
        </tbody>
        ...
        <tbody id="trips-riding">
          <tr>
            <td id="trips-riding-status" colspan="5">
              ...
              <em id="trips-riding-msg" style="display: none;">There are no upcoming trips for which you are riding with
                someone.</em>
            </td>
          </tr>
        </tbody>
  ...
  <div id="modal-ride-requests" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="manage-label"
    aria-hidden="true">
    ...
    <div class="modal-body">
      <div id="modal-ride-requests-spots-remaining"><strong>Spots Remaining: </strong><span
          id="modal-ride-requests-spots-remaining-value">0</span></div>
      ...
      <div id="modal-ride-requests-status">
        ...
        <em id="modal-ride-requests-msg" style="display: none;">There are no upcoming trips for which you are
          driving.</em>
      </div>
    </div>
    <!--  Form Actions -->
